      ...
      {[
        {
          ...
          bodyJa:
            "本プラットフォームにアクセスまたはご利用いただくことで、本利用規約に同意したものとみなします。",
        },
        {
          en: "2. Use of Service",
          ja: "第2条（サービスの利用）",
          bodyEn:
            "Users agree to use this platform only for lawful purposes and in a manner that does not infringe the rights of others.",
          bodyJa:
            "ユーザーは、本プラットフォームを合法的な目的のみに使用し、他者の権利を侵害しない方法で利用することに同意します。",
        },
        {
          en: "3. User Accounts",
          ja: "第3条（ユーザーアカウント）",
        ...
        },
        {
          ...
          ja: "第4条（イベント・コンテンツ）",
          bodyEn:
            "Event organizers are solely responsible for the accuracy of event information.",
          bodyJa:
            "イベント主催者は、イベント情報の正確性について単独で責任を負います。",
        },
        {
          en: "5. Disclaimer of Liability",
          ja: "第5条（免責事項）",
          bodyEn:
            "This platform is provided 'as is' without warranties of any kind. We are not liable for any damages arising from the use of this service.",
          bodyJa:
            "本プラットフォームは「現状のまま」提供され、いかなる種類の保証もありません。",
        },
        {
          en: "6. Privacy",
          ja: "第6条（プライバシー）",
          ...
          bodyJa:
            "当社は、プライバシーポリシーに従って個人データを収集・処理します。",
        },
        {
